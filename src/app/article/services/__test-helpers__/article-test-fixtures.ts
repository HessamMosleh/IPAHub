...
export const FIXED_ARTICLE_ID = '507f1f77bcf86cd799439011';
...
export interface ArticleFixtureOverrides {
  _id?: any;
...
/**
 * Build a fresh, isolated Article-like object. Each call returns a new object
 ...
 */
export const buildArticle = (overrides: ArticleFixtureOverrides = {}) => ({
...
export const buildArticleModelMock = () => ({
  find: jest.fn(),
  findOne: jest.fn(),
  findById: jest.fn(),
  create: jest.fn(),
