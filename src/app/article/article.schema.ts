...
/**
 * National articles are shown everywhere; a provincial article belongs to the `province`
...
export class Article extends Document {
  ...
  @Prop({
    ...
    default: ArticleCategory.NATIONAL,
  })
  ...
  @Prop({
    type: String,
    enum: ArticleStatus,
    default: ArticleStatus.REGISTERING,
  })
...
ArticleSchema.index({ category: 1, province: 1 });
